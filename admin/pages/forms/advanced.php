...
if(isset($_POST['submit']))
    {
        ...
        $sql="INSERT INTO `instructor`(`instructor`, `image`, `about`, `courses`, `students`) VALUES ('$instructor','$image','$about',' $courses','$students')";
...
<?php include("sidebar.php")?>
  ...
  <div class="content-wrapper">
            ...
            <div class="card card-primary">
              ...
              <form class="form-sample" method="post" enctype="multipart/form-data">
                ...
                <div class="col-md-6">
                  <div class="form-group col">
                    ...
                    <input type="text" class="form-control" value="" name="instructor" >
                  </div>
                  </div>
                  <div class="col-md-6">
                  <div class="form-group col">
              ...
              <div class="col-md-6">
                  <div class="form-group col">
                    ...
                    <input type="text" class="form-control" name="students" value="" >
                  </div>
                  </div>
    ...
    ?>
                    ...
                    <td><?php echo $arr['instructor'];?></td>
                    
                    <td><img src="../../dist/img/credit/<?php echo $arr['image'];?>" style="height:150px; width:150px;"></td>
